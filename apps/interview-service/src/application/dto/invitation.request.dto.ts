...
export class CreateInvitationDto {
  ...
  @ApiPropertyOptional({
    description: 'Candidate email (denormalized for notifications)',
  ...
  @ApiPropertyOptional({
    description: 'Candidate name (denormalized for notifications)',
    example: 'John Doe',
  })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({
    description: 'HR email (denormalized for notifications)',
  ...
  @ApiPropertyOptional({
    description: 'HR name (denormalized for notifications)',
    example: 'Jane Smith',
  })
  @IsOptional()
  @IsString()
