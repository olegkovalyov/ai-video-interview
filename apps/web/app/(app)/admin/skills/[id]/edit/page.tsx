...
export default function EditSkillPage() {
  ...
  const { data: skill, isPending: loading } = useSkill(skillId);
      ...
      <Card>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              <Label>Slug</Label>
              <Input value={skill.slug} disabled className="bg-muted" />
            ...
            <div className="flex items-center gap-3 border-t pt-4 text-xs text-muted-foreground">
              ...
              <Badge variant={skill.isActive ? "success" : "error"}>
