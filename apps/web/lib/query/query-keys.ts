...
export const invitationKeys = {
  ...
  hrList: (filters?: InvitationFilters) =>
    [...invitationKeys.hr(), filters] as const,
  candidate: () => [...invitationKeys.all, "candidate"] as const,
  candidateList: (filters?: InvitationFilters) =>
    [...invitationKeys.candidate(), filters] as const,
...
export const candidateSearchKeys = {
  ...
  search: (filters?: CandidateSearchFilters) =>
    [...candidateSearchKeys.all, filters] as const,
};

export const analysisKeys = {
  all: ["analysis"] as const,
  detail: (invitationId: string) =>
    [...analysisKeys.all, invitationId] as const,
  status: (invitationId: string) =>
