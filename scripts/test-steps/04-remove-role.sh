...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo -e "${BLUE}🎭 STEP 4: REMOVE ROLE${NC}"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
...
echo "2. User Service logs - INBOX processing + RemoveRoleCommand"
echo "3. PostgreSQL:"
echo "   SELECT * FROM inbox WHERE event_type = 'user.role_removed' ORDER BY created_at DESC LIMIT 1;"
echo "   SELECT * FROM outbox WHERE event_type = 'user.role_removed' ORDER BY created_at DESC LIMIT 1;"
echo "4. Get roles:"
echo "   curl http://localhost:8001/api/admin/users/${KEYCLOAK_ID}/roles | jq"
